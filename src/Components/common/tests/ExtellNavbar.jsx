...
const ExtellNavbar = () => {
  ...
  // Check if the path is an external URL (starting with http:// or https://)
  if (path.startsWith("http://") || path.startsWith("https://")) {
    // If it’s an external link, use window.location.href
    window.location.href = path;
  } else {
    // Otherwise, navigate internally using React Router's navigate
    navigate(path);
  }
};
...
<li className="nav-item">
  <a
    href="/projects"  // This will be ignored when handleNavClick is used
    className="nav-link"
    data-bs-dismiss="offcanvas"
    onClick={(e) => handleNavClick(e, "https://agamcreatives.site/landing_page/")}
  >
    Ongoing Project
  </a>
</li>
