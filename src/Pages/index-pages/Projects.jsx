        ...
        <div className=" p-2">
          ...
          <div className="d-flex justify-content-start gap-2 mb-4 flex-wrap">
            {filters.map((item) => (
              <button
                key={item}
                className={`filter-btn btn btn-sm ${filter === item ? 'btn-dark' : 'btn-outline-secondary'
                  }`}
          ...
          <div className="row projects-page-row">
            {/* left: Map */}
            <div className="col-md-6 projects-map-col">
              <div className=''>
              ...
              <div className="row d-flex justify-content-start">
                {filteredProjects.map((property) => (
                  ...
                  <div className="col-md-4 mb-4" key={property.id}>
                    <Link to={`/projects/${property.slug}`} className="text-decoration-none">
                    <div
                    ...
                    >
                      ...
                      <div className="card-body">
                        <h6 className="subTitleGreen fs-6 text-start">{property.name}</h6>
