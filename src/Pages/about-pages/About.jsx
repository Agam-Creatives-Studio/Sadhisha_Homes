        ...
        <Section>
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-md-6 mb-4 mb-md-0">
              <div className="d-md-block d-none">
                <h2 style={{ textTransform: 'uppercase' }}className="secTitleGreen fs-1 text-md-start text-center">Message From Chairman</h2>
                <p className="subParaTextGreen text-uppercase mb-md-4 mb-2 text-md-start text-center"   >From Years of Industry Expertise   </p>
      ...
      <div className='bgGreen px-md-0 px-2'>
        <Section>
          ...
          <div className="row justify-content-center d-flex  py-2">
            ...
            <div className="pt-4">
              <h4 style={{ textTransform: 'uppercase' }} className="subTitleWhite mb-md-2 mb-2 fs-2 text-center"> Bipin Rananaware</h4>
          ...
          <div className="d-md-none d-block py-4">
            <h4 style={{ textTransform: 'uppercase' }} className="subTitleWhite mb-md-2 mb-2 fs-2 text-md-start text-center"> Bharathi Rananaware</h4>
        ...
        <Section>
          <div className="row align-items-center justify-content-between">
            ...
            <div className="col-md-5 mb-4 mb-md-0 order-md-1 order-2">
              ...
              <div className="d-md-block d-none">
                <h2 style={{ textTransform: 'uppercase' }} className="secTitleGreen text-md-start text-center">Life at Sadhisha</h2>
                <p className="subParaTextGreen text-uppercase mb-md-4 mb-2 text-md-start text-center"   >People First, always</p>
